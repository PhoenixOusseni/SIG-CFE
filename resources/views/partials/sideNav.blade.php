            ...
            <div class="sidenav-menu">
                <div class="nav accordion" id="accordionSidenav">
                    ...
                    <a class="nav-link collapsed" href="javascript:void(0);" data-bs-toggle="collapse"
                        ...
                        <div class="nav-link-icon"><i data-feather="settings"></i></div>Paramètres
                        <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>
                    ...
                    {{-- <a class="nav-link collapsed" href="javascript:void(0);" data-bs-toggle="collapse"
                        ...
                        <div class="collapse" id="pagesCollapseErrorEval" data-bs-parent="#accordionSidenav">
                            <nav class="sidenav-menu-nested nav">
                                <a class="nav-link" href="">Lettre de mission</a>
                                <a class="nav-link" href="">Attestation service fait</a>
                                <a class="nav-link" href="">Efficacité du personnel</a>
                    ...
                    {{-- @if (in_array(Auth::user()->module, ['diligence', 'tous']))
                        ...
                        <a class="nav-link collapsed" href="{{ route('gestion_marche.index') }}">
