...
<body style="height: 90vh;">
    <div id="layoutSidenav_content">
        ...
        <div class="text-center mt-3">
            <h2><strong>NOTE D'HONORAIRES INTERNE N° <span class="text-danger">{{ $recette->code }}</span></strong></h2>
        ...
        <div class="d-flex justify-content-between m-3">
            <div class="col-12" style="border: 1px solid black; padding: 5px;">
                <h5>Client : <strong>{{ $recette->Contribuable->assujeti }}</strong></h5>
                <h5>Adresse : <strong>{{ $recette->Contribuable->adresse }}</strong> | Téléphone : <strong>{{ $recette->Contribuable->telephone }}</strong></h5>
        ...
        <div class="m-3">
            ...
            <div class="mt-4">
                <h5 class="text-danger">Conditions : Sur présentation de la facture</h5>
            </div>

            <div class="mt-4">
                Division fiscale : DME-CV <br>
                Régime Normal d’imposition <br>
                <span class="text-danger">N° IFU : 00019969J</span> <br>
                Forme juridique : SA <br>
                <span class="text-danger">Notre Adresse Cadastrale : Parcelle 03, Lot 13, Section 006(AI), Secteur 04 (ZACA)</span>
            </div>
