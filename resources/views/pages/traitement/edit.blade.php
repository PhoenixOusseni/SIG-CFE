...
@section('title')
    <title>SIG - CFE | Modifier traitement</title>
@endsection
            ...
            <div class="col-lg-12">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <form action="{{ route('gestion_traitement.update', $finds->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" name="date_debut" class="form-control" value="{{ $finds->date_debut ?? '' }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="small">Au</label>
                                    <input type="date" name="date_fin" class="form-control" value="{{ $finds->date_fin ?? '' }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="commentaire" class="form-control" cols="30" rows="10">{{ $finds->commentaire ?? '' }}</textarea>
                                </div>
                            </div>

                            <div class="m-0">
                                <button type="submit" class="btn btn-dark"><i
                                        data-feather="edit"></i>&thinsp;&thinsp; Modifier</button>
