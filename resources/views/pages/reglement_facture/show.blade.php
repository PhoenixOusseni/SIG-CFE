...
@section('title')
    <title>SIG - CFE | Regelement facture fournisseur</title>
@endsection
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            <h1 class="page-header-title">
                                ...
                                Réglement facture fournisseur N° {{ $reglement->id }}
                            </h1>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card card-default">
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="net" type="number" value="{{ $reglement->net }}" readonly/>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-12">
                                            <div class="mb-3">
                                                <label class="small mb-1">Reste à payer</label>
                                                <input class="form-control" name="reste" type="number" value="{{ $reglement->reste }}" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="mt-3">
                                    ...
                                    <a href="{{ url('print_reglement_facture/' . $reglement->id) }}" class="btn btn-secondary">
