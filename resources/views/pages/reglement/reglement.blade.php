...
@section('content')
    <main>
        ...
        <div class="container-xl px-4 mt-n10" style="margin-bottom: 8rem;">
            ...
            <form action="{{ route('module_reglement.update', [$recette->id]) }}" method="POST">
                @csrf
                @method('PATCH')
                <div class="card mb-4">
                        ...
                        <div class="card card-default">
                            <div class="card-body">
                                <fieldset class="w-100 p-2" style="border-radius: 5px; background: rgb(234, 233, 233)">
                                    <div class="row">
                                        <input class="form-control" name="recettes_id" type="text" value="{{ $recette->id }}" hidden />
                                        ...
                                        <div class="col-lg-4 col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="net" type="number" value="{{ $total }}" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
