...
@section('content')
    ...
    <div class="container-xl px-4 mt-n10">
        ...
        <div class="card filter-card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('facture_par_categorie') }}" method="GET">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <a href="{{ route('facture_par_categorie') }}" class="btn btn-primary">
            ...
            <div class="result-card card">
                ...
                <div class="card-body">
                    ...
                    @foreach ($resultats as $resultat)
                        ...
                        <div class="categorie-info-box">
                            <h4>
                                <i data-feather="tag"></i> {{ $resultat->categorie->libelle }}
                            </h4>
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        @else
                            <div class="alert alert-info mt-3">
                                <i data-feather="info"></i> Aucune recette trouvée pour cette catégorie dans la période
                                sélectionnée.
                            </div>
                        @endif
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="stats-card">
                                        ...
                                        <div class="stats-value danger">{{ $grandTotalRecettes }}</div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="stats-card">
        ...
        @elseif(request()->has('categorie_id') || request()->has('date_debut') || request()->has('date_fin'))
            <div class="result-card card">
                <div class="card-body">
            ...
            <div class="result-card card">
                <div class="card-body">
                    <div class="no-data-message">
                        ...
                        <p>Sélectionnez une catégorie et/ou une période pour afficher les recettes associées.</p>
                    </div>
                </div>
            </div>
        @endif
