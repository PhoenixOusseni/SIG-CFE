...
<head>
    ...
    <style>
        ...
        .table-print th, .table-print td { border: 1px solid #000; padding: 8px; text-align: left; font-size: 11px; }
...
<body>
    <div id="layoutSidenav_content">
        ...
        <div class="text-center" style="margin: 30px 0;">
            <h3><strong>ÉTAT DES RECETTES PAR DÉPARTEMENT/SERVICE</strong></h3>
            ...
            @foreach($resultats as $result)
                <div style="margin-bottom: 40px; page-break-inside: avoid;">
                    <h4 style="background: #f5f5f5; padding: 10px; border-left: 4px solid #007bff;">
                        Service/Département : {{ $result->service->libelle }}
                    </h4>
                    ...
                    <table class="table-print">
                        ...
                        <tbody>
                            ...
                            <tr style="background: #e9ecef; font-weight: bold;">
                                <td colspan="6" style="text-align: right;">TOTAL {{ strtoupper($result->service->libelle) }}</td>
