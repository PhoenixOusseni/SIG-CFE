...
@section('title')
    <title>SIG - CFE | Modifier une diligence</title>
@endsection
            ...
            <div class="col-lg-12">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <form action="{{ route('gestion_diligence.update', $finds->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                <div class="col-md-6">
